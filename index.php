...
$lots=[			
	[
		...
		'price'=>10999,
		'capture'=>'img/lot-1.jpg'
	],
	[
		'name'=>'DC Ply Mens 2016/2017 Snowboard',
		'categories'=>'Доски и лыжи',
		'price'=>159999,
		'capture' =>'img/lot-2.jpg'
	],
	[
		'name'=> 'Крепления Union Contact Pro 2015 года размер L/XL',
		'categories'=>'Крепления',
		'price'=>8000,
		'capture'=>'img/lot-3.jpg'
	],
	[
		'name'=> 'Ботинки для сноуборда DC Mutiny Charocal',
		'categories'=>'Ботинки',
		'price'=>10999,
		'capture'=>'img/lot-4.jpg'
	],
	[
		'name'=> 'Куртка для сноуборда DC Mutiny Charocal',
		'categories'=>'Одежда',
		'price'=>7500,
		'capture'   =>'img/lot-5.jpg'
	],
	[
		'name'=> 'Маска Oakley Canopy',
		'categories'=>'Разное',
		'price'=>5400,
		'capture'=>'img/lot-6.jpg'
	]
];
?>
<!DOCTYPE html>
    ...
    <section class="promo">
        ...
        <ul class="promo__list">
            ...
            <li class="promo__item promo__item--<?=$value["class"];?>">
                <a class="promo__link" href="pages/all-lots.html"><?=$value["name"];?>			
				</a>
            </li>
		  <?php endforeach;?>
        </ul>
    ...
    <section class="lots">
        ...
        <ul class="lots__list">
		  <?php foreach($lots as $key=>$value):?>
            <li class="lots__item lots">
                <div class="lot__image">
                    <img src="<?=$value["capture"];?>" width="350" height="260" alt="">
                </div>
                <div class="lot__info">
